...
I've used a simulator where I could steer a car around a track for data collection. I've used the image data and steering angles to train a neural network and then used this model to drive the car autonomously around the track.
...
More details about the steps I took to complete this project can be found in my [writeup report](https://github.com/vinny-palumbo/AutonomousCars-DrivingBehaviorCloning/blob/master/writeup_report.md)

### Dependencies

* Environment: [CarND Term1 Starter Kit](https://github.com/udacity/CarND-Term1-Starter-Kit) 
